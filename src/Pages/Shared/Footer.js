    ...
    return (
        <footer className="footer footer-center p-10 bg-black text-white rounded">
            <div className="grid grid-flow-col gap-4">
                ...
                <Link to="/portfolio">Press kit</Link>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
